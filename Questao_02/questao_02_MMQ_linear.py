...
valores_x_vezes_y = x_vezes_y(x, y)
...
print('-' * 30)
print(f'A equação da reta é: g(x) = {valor_a:.3f}X  {valor_b:.3f}')
print('-' * 30)
print(f'A estimativa da concentração em 2015 é de {g(2015, valor_a, valor_b):,.3f} ppm')
print(f'A estimativa da concentração em 2020 é de {g(2020, valor_a, valor_b):,.3f} ppm')
