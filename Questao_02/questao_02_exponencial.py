...
print('-' * 30)
print(f'A estimativa da concentração em 2015 é de {g(2015, valor_a, b_real):,.3f} ppm')
print(f'A estimativa da concentração em 2020 é de {g(2020, valor_a, b_real):,.3f} ppm')
